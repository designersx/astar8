...
import {  editPlanetNumbers } from "../../lib/Store";

const PlanetNumbersEdit = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await editPlanetNumbers(id, updatedData);
        ...
        <div className="pd-20 card-box mb-30">
          <form onSubmit={handleSubmit}>
            <div className="row">
              ...
              <div className="col-xs-12 col-sm-12 col-md-12">
                <div className="form-group">
                  <strong>Ruling Number:</strong>
                  <input
                    placeholder="Ruling Number"
                    className="form-control ruling"
                    disabled
                    name="ruling"
                    cols={40}
                    rows={1}
                    defaultValue={data.ruling_number}
                  />
                </div>
              </div>
              <div className="col-xs-12 col-sm-12 col-md-12">
...
export default PlanetNumbersEdit;
