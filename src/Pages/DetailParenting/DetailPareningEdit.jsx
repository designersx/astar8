...
import { editDetailedParenting } from "../../lib/Store";

const DetailPareningEdit = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await editDetailedParenting(id, updatedData);
...
export default DetailPareningEdit;
