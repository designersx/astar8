...
import { editbasicMoney, editDetailedMoney, editDetailedParenting } from "../../lib/Store";

const DetailedMoneyEdit = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await editDetailedMoney(id, updatedData);
...
export default DetailedMoneyEdit;
