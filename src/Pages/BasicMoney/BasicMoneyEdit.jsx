...
import { editbasicMoney, editDetailedParenting } from "../../lib/Store";

const BasicMoneyEdit = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await editbasicMoney(id, updatedData);
